...
import com.file.evolution.application.settings.AppCompatPreferenceActivity;
import com.file.evolution.application.settings.AppSettings;

public class ApplicationSettingActivity extends AppCompatPreferenceActivity {

	public static void startThisActivity(Context context) {
		Intent intent = new Intent(context, ApplicationSettingActivity.class);
		context.startActivity(intent);
	}

	public static void startThisActivityForResult(Activity activity, int requestCode) {
		Intent intent = new Intent(activity, ApplicationSettingActivity.class);
