...
public class VideoInfoDialogFragment extends BottomSheetDialogFragment {

    public static final String TAG = VideoInfoDialogFragment.class.getSimpleName();
    ...
    public static VideoInfoDialogFragment newInstance(String file) {
        VideoInfoDialogFragment fragment = new VideoInfoDialogFragment();
        currentPath = file;
        return fragment;
    }
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        videoInfo.add(new VideoInfo("Resolusi :", width + "x" + height));
        videoInfo.add(new VideoInfo("Bitrate :", bps + "Mbps"));
        videoInfo.add(new VideoInfo("Ukuran File :", Formatter.formatFileSize(getActivity(), fileSize)));
        videoInfo.add(new VideoInfo("Durasi :", getTimeString(Integer.valueOf(duration))));
