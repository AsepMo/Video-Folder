...
public class DirectoryNavigationView {
    ...
    public OnUpdatePathListener mOnUpdatePathListener;
    ...
    public void setDirectoryButtons(String path) {
        ...
        t0.setTextColor(mActivity.getResources().getColor(R.color.title_navigation_view));        
        t0.setTag(dir);
        ...
        for (int i = 1; i < parts.length; i++) {
            ...
            t2.setTextColor(mActivity.getResources().getColor(R.color.title_navigation_view));
            t2.setTag(dir);
            ...
            t2.setOnLongClickListener(new View.OnLongClickListener() {
                public boolean onLongClick(View view) {
                    String dir1 = (String) view.getTag();
                    ActionMenuFolder.savetoClipBoard(mActivity, dir1);
                    return true;
                }
            });
    ...
    public  void setOnUpdatePath(OnUpdatePathListener mOnUpdatePathListener){
        this.mOnUpdatePathListener = mOnUpdatePathListener;
    }
